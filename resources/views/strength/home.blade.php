        ...
        <div  @if($comment->talker_id==$user->id)   class="card-body text-success"@else class="card-body"  @endif>
            ...
            <div class="text-right">
                <like-component v-bind:comment_id="{{$comment->id}}" v-bind:like_count="{{$comment->likes->count()}}"
                    v-bind:like_flag='@json($comment->like_flag)'></like-component>
            </div>
        </div>
    </div>
    @endforeach
...
<div class="post-button">
    <button type="button" class="btn rounded-circle border border-danger" data-toggle="modal"
            ...
            <div class="modal-content">
                ...
                <form method="post" action="./tweet/post">
                    ...
                    <div class="modal-body p-0">
                        <textarea name="tweet" id="tweet" cols="30" rows="10" class="w-100 h-100"
